...
const App = () => {
  ...
  return (
    <Box sx={{ justifyContent: 'center' }}>{localStorage.getItem('token') ? (<LoggedNarbar></LoggedNarbar>) : (<Navbar></Navbar>)}
      <Box sx={{ margin: 'auto', display: 'flex', mt: 10, width: '60%', height: '60vh', justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', borderWidth: '0px', borderStyle: 'solid' }}>
